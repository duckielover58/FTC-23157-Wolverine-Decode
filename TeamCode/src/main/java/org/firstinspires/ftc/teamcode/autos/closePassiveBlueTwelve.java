...
// RR-specific imports
// Mirroring: Assuming nearBlue constants exist in GlobalVariable
...
@Config
@Autonomous(name = "Close Blue - Spike Intake", group = "Robot")
public class closePassiveBlueTwelve extends LinearOpMode {
