...
@Config
@Autonomous(name = "farPassiveCycle", group = "Robot")
public class farPassiveCycle extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        PinpointDrive drive = new PinpointDrive(hardwareMap, new Pose2d((24*3), 11, Math.toRadians(180)));
      ...
      //  limelight.stop();
       // Actions.runBlocking(limelight1.motifCheck());
        ...
        Action shootThreeBalls21 = drive.actionBuilder(new Pose2d(((24*3)), 12, Math.toRadians(165)))
                .waitSeconds(5)
        ...
        Action shootThreeBalls22 = drive.actionBuilder(new Pose2d(((24*3)), 12, Math.toRadians(165)))
                .waitSeconds(5)
                .stopAndAdd(new SequentialAction(
                        new InstantAction(() -> ServoLocked = false),
                        hood.ten(),
        ...
        Action shootThreeBalls23 = drive.actionBuilder(new Pose2d(((24*3)), 12, Math.toRadians(165)))
                .waitSeconds(5)
                .stopAndAdd(new SequentialAction(
                        new InstantAction(() -> ServoLocked = false),
                        hood.ten(),
        ...
        Action farPassive = drive.actionBuilder(new Pose2d(((24*3)), 12, Math.toRadians(165)))
                .setTangent(90)
                .strafeToLinearHeading(new Vector2d(((24*3)), 40), Math.toRadians(90))
...
//                .splineToLinearHeading(new Pose2d(((24*3)-35), 63, Math.toRadians(90)), Math.toRadians(90))
                ...
                .strafeToLinearHeading(new Vector2d(((24*3)), 12), Math.toRadians(180))
                .build();
        if (motif == 21) {
